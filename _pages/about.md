...
allowing us to investigate their structure, dynamics, and biogeochemical
variability across a wide range of temporal and spatial scales.

<!-- ===================== YOUTUBE VIDEO ===================== -->

<div style="position:relative; padding-bottom:56.25%; height:0; margin:1.5rem 0;">
  <iframe
    src="https://www.youtube.com/embed/ueL2FWVcLWc"
    title="OCW RGB animation"
    frameborder="0"
...
<img src="{{ '/assets/images/wep_page_physic.png' | relative_url }}"
     style="width:100%; max-height:450px; object-fit:contain; margin:2rem 0;">
